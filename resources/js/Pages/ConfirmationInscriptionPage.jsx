        ...
        <>
            ...
            <div className=" mx-auto rounded-lg ">
                    ...
                    <div className="flex md:flex-row flex-col justify-between space-y-2 md:space-x-6 md:space-y-0 mb-5 text-gray-300">
                        {formation && (
                            <div className="md:mb-0 mb-6 border border-dashed border-gray-500 p-4 flex-1" >
                                ...
                                <p className="mb-2">{formation.description_courte}</p>
              ...
              Fo          </div>
                ...
                <Link href={route('formation')} className="bg-secondary inline-block px-4 py-4 rounded-lg font-bold hover:bg-black/40 mx-auto text-center ">Retour à la page formation</Link>
                    <a href="https://chat.whatsapp.com/FVzISrFEDCs1NKAIcw3PzD" className="bg-primary inline-block px-4 py-4 rounded-lg font-bold hover:bg-green-700 mx-auto text-center ">Rejoindre la communauté</a>
                </div>
