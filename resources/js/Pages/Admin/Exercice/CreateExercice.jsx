...
const CreateExercice = () => {
    ...
    const [formData, setFormData] = useState({ title: '', description: '', file: null, deadline: null, etat: 'en cours' })
    ...
    const handleSubmit = (e) => {
        ...
        console.log(formData)
         router.post(`${urlBackHierachie()}`, formData, {
             forceFormData: true
         })
    }
    return (
