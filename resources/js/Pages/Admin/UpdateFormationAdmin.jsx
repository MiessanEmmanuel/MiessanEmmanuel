...
const UpdateFormationAdmin = () => {
    const formation = usePage().props.formation
    const categories = usePage().props.categories
    const [imageDorigine, setImageDorigine] = useState(true)
    const image = useRef();
    ...
    const [formData, setFormData] = useState({
        ...
        imageDorigine: imageDorigine,
        lien_video: formation.lien_video,
        date_debut: formation.date_debut,
        heure_debut: formation.heure_debut,
        duree_unite: formation.duree_unite,
        duree_valeur: formation.duree_valeur,
        prerequis: formation.prerequis,
        audience: formation.audience,
        details: formation.details,
        niveau: formation.niveau,
        inscription_ouverte: formation.inscription_ouverte,
        date_limite_inscription: formation.date_limite_inscription,
        nombre_de_place: formation.nombre_de_place,
    ...
    const handleImageUpload = (e) => {
        ...
        setImageDorigine(false);
    };

    const handleSubmit = (e) => {
        e.preventDefault();
       console.log(imageDorigine);
        router.post(route('admin.formation.update'), formData, {
            onSuccess: () => {
        ...
        <>
            <HeaderAdmin>
                <div className="text-white p-0 md:p-8">
                    <h1 className="text-3xl font-bold mb-8">Éditer une Formation</h1>
                    <form onSubmit={handleSubmit} className="bg-secondary md:rounded-xl p-3 md:p-8 w-full md:max-w-5xl md:mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                {imageDorigine && <img className='size-7' src={formation.image} alt="oups" />}
                                ...
                                <div className="flex items-center bg-black/40 rounded-lg px-4 py-2" onClickCapture={() => { image.current.click() }}>
                                    ...
                                    {imageDorigine ? (formData.image ? formData.image.split('/').findLast((element) => element) : 'Choisir une image') : (formData.image ? formData.image.name : 'Choisir une image')}
...
export default UpdateFormationAdmin;
